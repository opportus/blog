...
<!-- +++++ About Section +++++ -->	
<div id="about" class="section-a"></div>
		...
		<div class="row">
			<div class="col-lg-6 mb">
				<section>
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras aliquam pellentesque sem id molestie.
					Pellentesque nec lectus a sapien posuere sollicitudin. Vivamus nec tortor turpis.<br />
...
<!-- +++++ Projects Section +++++ -->	
<div id="projects" class="section-a"></div>
<div class="section aqua pt">
	<div class="container">
		<section>
			<div class="row mb">
				<div class="col-lg-6 col-lg-offset-3 centered">
			...
			<div class="row centered">	
				<div class="col-lg-4 mb">
					<section>
						<a href="https://github.com/opportus/hedo/" target="_blank"><img class="img-responsive" src="<?php echo $toolbox->sanitizeUrl($config->get('App', 'app', 'url') . '/oc/blog/img/project-1.jpg'); ?>" alt="Hedo" /></a>
						<header>
							<h3 class="mt"><pn>MVC Framework Hedo</pn></h3>
						</header>
					</section>
				</div>
				<div class="col-lg-4 mb">
					<section>
						<a href="http://vps320850.ovh.net/les-films-de-plein-air.org/" target="_blank"><img class="img-responsive" src="<?php echo $toolbox->sanitizeUrl($config->get('App', 'app', 'url') . '/oc/blog/img/project-2.jpg'); ?>" alt="Les Films de Plein Air" /></a>
						<header>
				...
				<div class="col-lg-4 mb">
					<section>
						<a href="http://animochic.com/" target="_blank"><img class="img-responsive" src="<?php echo $toolbox->sanitizeUrl($config->get('App', 'app', 'url') . '/oc/blog/img/project-3.jpg'); ?>" alt="AnimoChic" /></a>
						<header>
...
<!-- +++++ Contact Section +++++ -->
<div id="contact" class="section-a"></div>
<div class="section white py">
	<div class="container">
		<section>
			<div class="row mb">
